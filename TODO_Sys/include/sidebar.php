...
<html lang="en">
<head>
  <title>TODO_Sys</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" href="assets/img/60727.png">
...
<nav class="navbar navbar-inverse sidebar navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="task-info.php"><span style=>
        <img src="assets/img/logo_trim.png" height="50px" width ="210px"></span></a>
    </div>
...
<nav class="navbar navbar-default custom-nav">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
       <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="assets/img/admin.png" width="50px">
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li class="bg-primary user"><a href="#"> <h4>Yash Pandhare</h4></a></li>
